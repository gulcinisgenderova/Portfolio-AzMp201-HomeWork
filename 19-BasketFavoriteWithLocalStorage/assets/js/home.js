...
function creatEd(elem) {
  ...
  card.style.border = '1px solid 0 4px 8px rgba(255, 140, 0, 0.5)';
  card.style.borderRadius = '8px';
  card.style.backgroundColor = '#fff';
  card.style.boxShadow = '0 4px 8px rgba(255, 140, 0, 0.5)';
  ...
  basketButton.style.marginTop = '10px';
  basketButton.style.padding = '8px 12px';
  basketButton.style.border = 'none';
  basketButton.style.borderRadius = '5px';
  basketButton.style.cursor = 'pointer';
  basketButton.style.backgroundColor = ' whitesmoke';
  basketButton.style.color = 'red';
  basketButton.style.fontSize = '25px';
  basketButton.style.fontWeight = 'bold';
  basketButton.style.transition = 'background-color 0.3s ease';



  favButton.style.display = 'inline-block';
  favButton.style.marginTop = '10px';
  favButton.style.marginLeft = '20px';
  favButton.style.padding = '8px 12px';
  favButton.style.border = 'none';
  favButton.style.borderRadius = '5px';
  favButton.style.cursor = 'pointer';
  favButton.style.backgroundColor = 'whitesmoke';
  favButton.style.color = ' orangered';
...
favButton.addEventListener("click", (e) => {
  ...
  card.append(cardImg,cardTitle,cardPrice,basketButton,favButton)
